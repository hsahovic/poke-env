...
.. warning:: This module currently supports most gen 8 and 7 single battle formats. Support for doubles is planned for the furutre. If you want a specific format to be supported, please `open an issue <https://github.com/hsahovic/poke-env/issues>`__.

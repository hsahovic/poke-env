...
class Gen4EnvSinglePlayer(GymnasiumEnv):
...
class Gen6EnvSinglePlayer(GymnasiumEnv):
...
class Gen7EnvSinglePlayer(GymnasiumEnv):
...
class Gen8EnvSinglePlayer(GymnasiumEnv):
...
class Gen9EnvSinglePlayer(GymnasiumEnv):

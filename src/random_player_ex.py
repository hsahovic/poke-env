...
async def main():
    ...
    player_1_configuration = PlayerConfiguration("satunicarina", "L.M.Montgomery7")
    player_2_configuration = PlayerConfiguration("duanicarina", "L.M.Montgomery7")
    player_3_configuration = PlayerConfiguration("tiganicarina", "L.M.Montgomery7")
